...
function useRouteParams() {
    return React.useContext(exports.RouteContext);
}
...
exports.Route = ({ onEnter, onLeave, onUpdate, path, children, isExact }) => {
    ...
    const parentParams = React.useContext(exports.RouteContext);
    ...
    const view = React.useMemo(() => React.createElement(MemoRoute, { onEnter: onEnter, onLeave: onLeave, onUpdate: onUpdate, params: Object.assign({}, parentParams, params) }, children), [params, parentParams]);
